...
class DoctorAdmin(admin.ModelAdmin):
    list_display = ('name','doctor_id','works_in')
    list_filter = ('name','trained_in','works_in')
...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ('patient_name', 'physician', 'start_dt_time')
    list_filter = ('physician', 'start_dt_time')
